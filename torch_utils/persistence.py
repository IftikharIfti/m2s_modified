...
def persistent_class(orig_class):
    ...
    class Decorator(orig_class):
        ...
        def init_kwargs(self):
            ...
            return dnnlib_amed.EasyDict(copy.deepcopy(self._init_kwargs))
...
def import_hook(hook):
    ...
    `meta` is an instance of `dnnlib_amed.EasyDict` with the following fields:
...
def _reconstruct_persistent_obj(meta):
    ...
    a persistent object.
    """
    meta = dnnlib_amed.EasyDict(meta)
    meta.state = dnnlib_amed.EasyDict(meta.state)
